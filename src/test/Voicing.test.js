...
test('Voicing.getAllNoteSelections', function () {
    expect(Voicing_1.Voicing.getAllNoteSelections('C', 1)).toEqual([['E']]);
    expect(Voicing_1.Voicing.getAllNoteSelections('C7', 2)).toEqual([['E', 'Bb']]);
    expect(Voicing_1.Voicing.getAllNoteSelections('C7', 3))
        .toEqual([
        ['E', 'Bb', 'C'],
        ['E', 'Bb', 'G']
    ]);
    expect(Voicing_1.Voicing.getAllNoteSelections('C7', 4))
        .toEqual([
        ['E', 'Bb', 'C', 'G']
    ]);
    expect(Voicing_1.Voicing.getAllNoteSelections('C7', 5))
        .toEqual([
        ['E', 'Bb', 'C', 'G']
    ]);
});
test('Voicing.getAllVoicePermutations', function () {
    expect(Voicing_1.Voicing.getRequiredNotes('C')).toEqual(['E']);
    expect(Voicing_1.Voicing.getAllNoteSelections('C', 1)).toEqual([['E']]);
    expect(Voicing_1.Voicing.getAllVoicePermutations('C', 1)).toEqual([
        ['E'],
    ]);
    expect(Voicing_1.Voicing.getAllNoteSelections('C7', 1)).toEqual([['E'], ['Bb']]);
    expect(Voicing_1.Voicing.getVoicePermutations(['E'])).toEqual([['E']]);
    expect(Voicing_1.Voicing.getAllVoicePermutations('C7', 1)).toEqual([
        ['E'],
        ['Bb'],
    ]);
    expect(Voicing_1.Voicing.getAllVoicePermutations('C', 2)).toEqual([
        ['C', 'E'],
        ['E', 'G'],
    ]);
    expect(Voicing_1.Voicing.getOptionalNotes('C')).toEqual(['C', 'G']);
    expect(Voicing_1.Voicing.getAllVoicePermutations('C', 3)).toEqual([
        ['E', 'G', 'C'],
        ['C', 'E', 'G'],
        ['G', 'C', 'E'],
    ]);
    expect(Voicing_1.Voicing.getAllVoicePermutations('C7', 2)).toEqual([
        ['E', 'Bb'],
        ['Bb', 'E'],
    ]);
    expect(Voicing_1.Voicing.getAllVoicePermutations('C7', 3)).toEqual([
        ['E', 'Bb', 'C'],
        ['C', 'E', 'Bb'],
        ['E', 'G', 'Bb'],
        ['Bb', 'E', 'G'],
    ...
    expect(Voicing_1.Voicing.getAllVoicePermutations('C7', 4)).toEqual([
        ['E', 'G', 'Bb', 'C'],
        ['Bb', 'E', 'G', 'C'],
        ['C', 'E', 'G', 'Bb'],
        ['G', 'Bb', 'C', 'E'],
    ...
    expect(Voicing_1.Voicing.getAllVoicePermutations('C7', 4, { minTopDistance: 3 })).toEqual([
        ['Bb', 'E', 'G', 'C'],
        ['C', 'E', 'G', 'Bb'],
        ['G', 'Bb', 'C', 'E'],
        ['G', 'C', 'E', 'Bb']
    ]);
    expect(Voicing_1.Voicing.getAllVoicePermutations('C7', 4, { minTopDistance: 3, maxDistance: 6 })).toEqual([
        ['Bb', 'E', 'G', 'C'],
        ['C', 'E', 'G', 'Bb'],
        ['G', 'Bb', 'C', 'E'],
        ['G', 'C', 'E', 'Bb']
    ]);
    expect(Voicing_1.Voicing.getAllVoicePermutations('C7', 4, { maxDistance: 7 })).toEqual([
        ['E', 'Bb', 'C', 'G'],
        ['E', 'G', 'Bb', 'C'],
        ['Bb', 'E', 'G', 'C'],
        ['C', 'E', 'G', 'Bb'],
...
test('Voicing.getVoicePermutations', function () {
    ...
    expect(Voicing_1.Voicing.getVoicePermutations(['F', 'A', 'C', 'E'])).toEqual([['F', 'A', 'C', 'E'], ['C', 'E', 'F', 'A'], ['E', 'A', 'C', 'F']]);
    expect(Voicing_1.Voicing.getVoicePermutations(['F', 'A', 'C', 'E'], { topNotes: ['A', 'E'] })).toEqual([['F', 'A', 'C', 'E'], ['C', 'E', 'F', 'A']]);
    expect(Voicing_1.Voicing.getVoicePermutations(['F', 'A', 'C', 'E'], { bottomNotes: ['E'] }))
        .toEqual([['E', 'A', 'C', 'F']]);
    expect(Voicing_1.Voicing.getVoicePermutations(['F', 'A', 'C', 'E'], { bottomNotes: ['A'], minTopDistance: 0 }))
        .toEqual([['A', 'C', 'E', 'F']]);
    expect(Voicing_1.Voicing.getVoicePermutations(['B', 'D', 'F', 'A'])).toEqual([['B', 'D', 'F', 'A'],
        ['B', 'F', 'A', 'D'],
        ['D', 'F', 'A', 'B'],
        ['F', 'A', 'B', 'D'],
        ['A', 'D', 'F', 'B'],
    ]);
    expect(Voicing_1.Voicing.getVoicePermutations(['E', 'G', 'C'])).toEqual([['E', 'G', 'C'], ['G', 'C', 'E'], ['C', 'E', 'G']]);
