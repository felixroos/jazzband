...
var version = exports.version = "5.9.1";
...
window.onload = function () {
    var color = d3_1.scaleLinear().domain([45, 75]).interpolate(d3_1.interpolateHcl).range([d3_1.rgb("#007AFF"), d3_1.rgb('#FFF500')]);
    var svg = d3_1.select("body").append("svg").attr("width", width).attr("height", height);
    var elLength = 500;
    var noteNumber = 60;
    var element = svg.append("g");
    element.append("rect").attr("width", elLength).attr("height", 20).attr("rx", 5).attr("ry", 5).attr("x", 0).attr("y", (noteNumber - 45) * 12).attr("fill", color(noteNumber));
    element.append("text").attr("x", 3).attr("y", 15 + (noteNumber - 45) * 12).text('test');
};
},{"d3":"../node_modules/d3/index.js"}],"../../../.nvm/versions/node/v8.11.1/lib/node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
//# sourceMappingURL=/demo.6660fdce.map