...
var Pianist = /** @class */ (function (_super) {
    ...
    Pianist.prototype.playChord = function (chord, settings) {
        ...
        var notes = util_1.getNextVoicing(chord, this.getLastVoicing() /* , this.range */); // TODO: range currently only respects first note
        this.playedNotes.push([].concat(notes));
        if (this.playedNotes.length > 1) {
            var _a = util_1.analyzeVoiceLeading(this.playedNotes), movement = _a.movement, averageDifference = _a.averageDifference, latestDifference = _a.latestDifference, latestMovement = _a.latestMovement;
