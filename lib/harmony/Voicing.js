...
var Voicing = /** @class */ (function () {
    ...
    Voicing.getNextVoicing = function (chord, lastVoicing, options) {
        ...
        var _a = __assign({ range: ['C3', 'C5'], maxVoices: 4, forceDirection: null, maxDistance: 7, minBottomDistance: 3, minTopDistance: 2 }, options), maxVoices = _a.maxVoices, range = _a.range, forceDirection = _a.forceDirection;
        ...
        var direction = Voicing.getDesiredDirection(lastVoicing, range) || forceDirection;
        if (!direction) {
            var pick_2 = bestPick;
            choice = choices[0];
    ...
    Voicing.getDesiredDirection = function (voicing, range) {
        var thresholds = [3, 3];
