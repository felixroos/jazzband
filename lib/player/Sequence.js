...
var Sequence = /** @class */ (function () {
    ...
    Sequence.fillGrooves = function (groove, sourceEvents, mapFn, options) {
        ...
        var _loop_1 = function () {
            ...
            var insert = grooveEvents
                .map(function (e) { return (__assign({}, e, { path: Rhythm_1.Rhythm.addPaths([bar], e.path), time: e.time + time })); })
    ...
    Sequence.insertGrooves = function (groove, sourceEvents, mergeFn, options) {
        ...
        return sourceEvents.reduce(function (events, source) {
            ...
            var insert = grooveEvents
                .map(function (e) { return (__assign({}, e, { path: Rhythm_1.Rhythm.addPaths(source.path, e.path), time: e.time + source.time })); })
                .map(function (target, index) {
    ...
    Sequence.addTimeAndDuration = function (options) {
        ...
        return function (events, event, index) {
            ...
            return events.concat(__assign({}, event, { options: options, velocity: 1, duration: Rhythm_1.Rhythm.oldDuration(event.divisions, whole), time: last ? last.time + last.duration : 0 }));
        };
    };
