...
var Sheet = /** @class */ (function () {
    ...
    Sheet.from = function (sheet) {
        ...
        return __assign({}, sheet, { options: __assign({ forms: 1, arpeggio: false, bell: false, pedal: false, real: true, tightMelody: true, bpm: 120, swing: 0, fermataLength: 4, duckMeasures: 1, feel: 4, pulses: 4 }, sheet.options, { humanize: __assign({ velocity: 0.1, time: 0.002, duration: 0.002 }, (sheet.options.humanize || {})), voicings: __assign({ minBottomDistance: 3, minTopDistance: 2, logging: false, maxVoices: 4, range: ['C3', 'C6'], rangeBorders: [1, 1], maxDistance: 7, idleChance: 1 }, (sheet.options.voicings || {})) }) });
    };
