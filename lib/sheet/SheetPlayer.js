...
var SheetPlayer = /** @class */ (function () {
    ...
    SheetPlayer.play = function (sheet) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, swing, swingSubdivision, bpm, _b, _c, _d;
            return __generator(this, function (_e) {
                switch (_e.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, SheetPlayer.playBass(sheet)];
                    case 2:
                        /* Tone.Transport.swing = swing;
                        Tone.Transport.swingSubdivision = swingSubdivision; */
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        sequence = Sequence_1.Sequence.render(sheet).map(function (event) { return (__assign({}, event, { note: tonal_1.Note.simplify(event.value) })); }).filter(function (e) { return !!e.note; });
