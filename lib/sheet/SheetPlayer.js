...
var SheetPlayer = /** @class */ (function () {
    ...
    SheetPlayer.play = function (sheet) {
        sheet = __assign({ chords: [], melody: [], forms: 2, cycle: 4, bpm: 130, swing: 0.7, maxVoices: 4, rootless: true }, sheet);
        var chords = sheet.chords, melody = sheet.melody, forms = sheet.forms, title = sheet.title, cycle = sheet.cycle, swing = sheet.swing, bpm = sheet.bpm, maxVoices = sheet.maxVoices, rootless = sheet.rootless;
        ...
        if (chords) {
            SheetPlayer.comp(chords, { bass: bass, piano: piano, maxVoices: maxVoices, rootless: rootless }).start(0);
            ;
        }
        if (melody) {
    ...
    SheetPlayer.comp = function (sheet, _a) {
        var bass = _a.bass, piano = _a.piano, maxVoices = _a.maxVoices, rootless = _a.rootless;
        ...
        return new Tone.Sequence(function (time, event) {
            ...
            voicing = __1.Voicing.getNextVoicing(chord, latest, range, maxVoices, rootless);
