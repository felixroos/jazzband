...
var Sequence = /** @class */ (function () {
    ...
    Sequence.renderGrid = function (measures, options) {
        ...
        var flat = Sheet_1.Sheet.flatten(renderedMeasures, true)
    ...
    Sequence.renderMeasures = function (measures, options) {
        ...
        var chords = renderedMeasures.map(function (e) { return e.chords; });
    ...
    Sequence.render = function (sheet) {
        ...
        if (sheet.chords) {
            chords = Sequence.renderMeasures(sheet.chords, sheet.options).map(function (e) { return (__assign({}, e, { chord: e.value // to seperate melody from chord later
             })); });
    ...
    Sequence.addTimeAndDuration = function (options) {
        ...
        return function (events, event, index) {
            ...
            return events.concat(__assign({}, event, { options: options, velocity: 1, duration: Sequence.fraction(event.divisions, whole), time: last ? last.time + last.duration : 0 }));
        };
    };
    ...
    Sequence.renderVoicings = function (options) {
        ...
        return function (events, event, index) {
            ...
            return events.concat(voicing.map(function (note, index) {
                return __assign({}, event, { value: note, chord: event.chord });
            }));
        };
    };
    ...
    Sequence.renderBass = function (options) {
        return function (events, event, index, chords) {
            ...
            events.push(__assign({}, event, { value: root, duration: duration }));
    ...
    Sequence.inOut = function () { return function (event, idnex, events) {
