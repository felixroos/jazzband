...
var Sequence = /** @class */ (function () {
    ...
    Sequence.getOptions = function (options) {
        return __assign({ bpm: 120, pulses: 4 }, options);
    };
    ...
    Sequence.renderMeasures = function (measures, options) {
        options = this.getOptions(options);
        var renderedMeasures = Sheet_1.Sheet.render(measures, __assign({}, options, { property: 'body' }));
    ...
    Sequence.duckChordEvent = function (options) {
        return function (event, index, events) {
            ...
            if (options.tightMelody) {
                topNote = melody.find(function (n) { return Sequence.haveSamePath(n, event) && Harmony_1.Harmony.isValidNote(n.value); }
