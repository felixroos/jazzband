...
var Logger = /** @class */ (function () {
    ...
    Logger.logVoicing = function (_a) {
        var chord = _a.chord, lastVoicing = _a.lastVoicing, combinations = _a.combinations, bestPick = _a.bestPick, pick = _a.pick, range = _a.range, choice = _a.choice, direction = _a.direction, choices = _a.choices, force = _a.force;
