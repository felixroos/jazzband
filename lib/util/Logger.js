...
var Logger = /** @class */ (function () {
    ...
    Logger.logSequence = function (sequence) {
        ...
        sequence.reduce(function (blocks, event) {
            var alreadyParsed = !!blocks.find(function (b) { return Rhythm_1.Rhythm.haveSamePath(b, event); });
            if (alreadyParsed) {
                return blocks;
            }
            var sameTime = sequence.filter(function (e) { return Rhythm_1.Rhythm.haveSamePath(e, event); });
            var degrees;
