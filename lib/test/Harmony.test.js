...
test('getBassNote', function () {
    expect(Harmony_1.Harmony.getBassNote('C7')).toBe('C');
    expect(Harmony_1.Harmony.getBassNote('C7/Bb')).toBe('Bb');
    expect(Harmony_1.Harmony.getBassNote('F#^7')).toBe('F#');
    expect(Harmony_1.Harmony.getBassNote('Gb-7b5')).toBe('Gb');
    expect(Harmony_1.Harmony.getBassNote('Gb-7b5/Db')).toBe('Db');
    expect(Harmony_1.Harmony.getBassNote('')).toBe(null);
});
