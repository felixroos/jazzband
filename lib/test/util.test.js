...
test('parseChords', function () {
    expect(util_1.parseChords('D-7')).toEqual(['D-7']);
    expect(util_1.parseChords('D-7 G7 C^7')).toEqual([['D-7', 'G7', 'C^7']]);
    expect(util_1.parseChords('D-7 | G7 | C^7')).toEqual(['D-7', 'G7', 'C^7']);
    expect(util_1.parseChords('D-7 G7 | C^7')).toEqual([['D-7', 'G7'], 'C^7']);
    expect(util_1.parseChords("\n    C7  | F7 | C7 | C7\n    F7  | F7 | C7 | A7\n    D-7 | G7 | C7 | G7"))
        .toEqual([
        'C7', 'F7', 'C7', 'C7',
        'F7', 'F7', 'C7', 'A7',
        'D-7', 'G7', 'C7', 'G7'
...
test.only('parseChords: houses', function () {
    expect(util_1.parseChords("\n            |: C7  | F7 |1 C7 | C7 :|\n                        |2 C7 | C7  |\n            | F7   | F7 |  C7 | A7  |\n            | D-7  | G7 |  C7 | G7  |"))
        .toEqual([
        { chords: ['C7'], signs: ['{'] }, 'F7',
