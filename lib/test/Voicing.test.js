...
test('Voicing.getRequiredNotes', function () {
    ...
    expect(Voicing_1.Voicing.getRequiredNotes('C7sus')).toEqual(['F', 'Bb']);
    ...
    expect(Voicing_1.Voicing.getRequiredNotes('D-11')).toEqual(['F', 'G', 'C']);
    ...
    expect(Voicing_1.Voicing.getRequiredNotes('Ch7')).toEqual(['Eb', 'Gb', 'Bb']);
...
test('Voicing.getVoices', function () {
    ...
    expect(Voicing_1.Voicing.getVoices('Dh7', 4, false, 1)).toEqual(['F', 'Ab', 'C', 'E']);
    expect(Voicing_1.Voicing.getVoices('Dh7', 4, true, 1)).toEqual(['F', 'Ab', 'C', 'E']); // root stays because b5 needs root!
    ...
    expect(Voicing_1.Voicing.getVoicingCombinations(['C', 'E', 'Bb', 'Db'])).toEqual([['C', 'E', 'Bb', 'Db']]);
    // B7b9b5
    // G69
    // A-9 ???
...
test('Voicing.getVoicingCombinations', function () {
    ...
    expect(Voicing_1.Voicing.getVoicingCombinations(['F', 'A', 'C', 'E'], { bottomNotes: ['A'], minTopDistance: 0 }))
        .toEqual([['A', 'C', 'E', 'F']]);
    expect(Voicing_1.Voicing.getVoicingCombinations(['B', 'D', 'F', 'A'])).toEqual([['B', 'D', 'F', 'A'], ['B', 'F', 'A', 'D'], ['F', 'A', 'B', 'D'], ['A', 'D', 'F', 'B']]);
