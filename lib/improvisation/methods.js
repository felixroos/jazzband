...
exports.scalePendulum = exports.advancedPermutator.enhance(__assign({}, beatPattern({ pattern: [1, 2, 3, 4, 5, 6, 7] }), pendulum(), straightNotes(8)));
...
exports.digitalPendulum = exports.advancedPermutator.enhance(__assign({ pattern: function (_a) {
        var chord = _a.chord;
        return util_1.getDigitalPattern(chord());
    } }, pendulum('up', false, 1), straightNotes(4), { 
    /* lineBreaks: ({ isBarStart }) => isBarStart(), */
    exclude: 1, reach: 1 }));
exports.digitalWalker = exports.advancedPermutator.enhance(__assign({ pattern: function (_a) {
        var chord = _a.chord;
        return util_1.getDigitalPattern(chord());
...
exports.heptatonicPractise = exports.advancedPermutator.enhance(__assign({}, patternPractise('up', 8, false), beatPattern({ barStart: [1], on: [3, 5, 7], off: [1, 2, 3, 4, 5, 6, 7] })));
...
exports.improvisationMethods = {
    ...
    digitalPractise: exports.digitalPractise,
    heptatonicPractise: exports.heptatonicPractise,
};
