...
function getStepsInChord(notes, chord, group) {
    var root = tonal_1.Chord.tokenize(Harmony_1.Harmony.getTonalChord(chord))[0];
    return notes.map(function (note) { return getStepFromInterval(tonal_1.Distance.interval(root, tonal_1.Note.pc(note))); });
}
