...
var SheetPlayer = /** @class */ (function () {
    ...
    SheetPlayer.play = function (sheet, options) {
        return __awaiter(this, void 0, void 0, function () {
            var chords, melody, swing, swingSubdivision, bpm, _a, _b;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, SheetPlayer.playChordSequence(chords, options)
    ...
    SheetPlayer.playChordSequence = function (measures, options) {
        if (options === void 0) { options = {}; }
        return __awaiter(this, void 0, void 0, function () {
            var _a, maxVoices, pedal, real, piano, multiplier, sequence, part;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        multiplier = 2;
                        sequence = Sheet_1.Sheet.getSequence({ chords: measures }, {
                            arpeggio: false,
                            bell: false,
                            logging: false,
                            pedal: false,
                            ...
                            time: event.position * multiplier,
                            note: tonal_1.Note.simplify(event.value),
                            velocity: 0.9,
                            duration: event.fraction * multiplier
                        }); });
